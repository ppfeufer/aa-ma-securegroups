...
# - absolute urls eg 'http://memberaudit_securegroups.com/dashboard'
...
INSTALLED_APPS += ["memberaudit_securegroups"]
...
# to https://memberaudit_securegroups.com/sso/callback substituting your domain for memberaudit_securegroups.com
...
# Set the default from email to something like 'noreply@memberaudit_securegroups.com'
